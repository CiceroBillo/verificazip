...
uses
  ...
  ACorpoEmailProposta in 'ACorpoEmailProposta.pas' {FCorpoEmailProposta},
  ...
  AAplicacao in 'AAplicacao.pas' {FAplicacao},
  ...
  AEnvioEmarketingProspect in 'AEnvioEmarketingProspect.pas' {FEnvioEMarketingProspect},
  ATreadEnviarEmail in 'ATreadEnviarEmail.pas',
  ...
  AMotivoAtraso in 'AMotivoAtraso.pas' {FMotivoAtraso},
  AMotivoAtrasoAmostra in 'AMotivoAtrasoAmostra.pas' {FMotivoAtrasoAmostra},
