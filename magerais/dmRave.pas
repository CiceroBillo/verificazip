...
type
  TdtRave = class(TDataModule)
    ...
    Promissoria: TClientDataSet;
    RvPromissoria: TRvDataSetConnection;
    PromissoriaDesDuplicata: TStringField;
    PromissoriaValDuplicata: TFloatField;
    PromissoriaDesValorExtenso: TStringField;
    PromissoriaDesLocaleData: TStringField;
    PromissoriaNumDiaVencimento: TIntegerField;
    PromissoriaDesDiaVencimento: TStringField;
    PromissoriaNumAnoVencimento: TStringField;
    PromissoriaDesMesVencimto: TStringField;
