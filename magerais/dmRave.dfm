object dtRave: TdtRave
  ...
  object Principal: TSQL
    ...
    ASqlQuery.SQL.Strings = (
        ...
        'select REC.DATEMISSAO, REC.SEQRECIBO, REC.VALTOTAL,  REC.INDCANC' +
        'ELADO, CLI.C_NOM_CLI  from RECIBOLOCACAOCORPO REC, CADCLIENTES C' +
        'LI  WHERE REC.CODCLIENTE = CLI.I_COD_CLI  AND REC.DATEMISSAO BET' +
        'WEEN to_date('#39'01/07/2011'#39','#39'DD/MM/YYYY'#39') AND to_date('#39'31/07/2011'#39 +
        ','#39'DD/MM/YYYY'#39')'
      'AND REC.CODFILIAL = 11'
      'ORDER BY REC.DATEMISSAO, REC.SEQRECIBO ')
