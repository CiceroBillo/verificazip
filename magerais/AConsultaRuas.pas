...
type
  TFConsultaRuas = class(TFormularioPermissao)
    ...
    procedure ECidadeKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure GConsultaKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  private
...
begin
  ...
  GravaEstatisticaConsulta(nil,Ender,varia.CodigoUsuario,Self.name,NomeModulo,Config.UtilizarPercentualConsulta);
...
{******************************************************************************}
procedure TFConsultaRuas.GConsultaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    13 : BOk.Click;
