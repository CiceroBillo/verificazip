...
uses
  ...
  ATipoTransferenciaCaixa in 'ATipoTransferenciaCaixa.pas' {FTipoTransferenciaCaixa},
  ANovaTransferenciaExterna in 'ANovaTransferenciaExterna.pas' {FNovaTransferenciaExterna},
  ANovaTransferenciaCheques in 'ANovaTransferenciaCheques.pas' {FNovaTransferenciaCheques},
  AReciboLocacao in '..\mpontaloja\AReciboLocacao.pas' {FReciboLocacao},
  AConsultaTransferencias in 'AConsultaTransferencias.pas' {FConsultaTransferencias},
