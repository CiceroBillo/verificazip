...
type
  TFUnidades = class(TFormularioPermissao)
    ...
    procedure CadUnidadeAfterPost(DataSet: TDataSet);
    procedure CadUnidades2BeforePost(DataSet: TDataSet);
    procedure CadUnidades2AfterPost(DataSet: TDataSet);
    procedure CadUnidades1AfterPost(DataSet: TDataSet);
    procedure CadUnidades1BeforePost(DataSet: TDataSet);
  private
...
begin
   Sistema.MarcaTabelaParaImportar('MOVINDICECONVERSAO');
   movIndiceConversao.close;
   movIndiceConversao.open;
end;
...
procedure TFUnidades.CadUnidadeAfterPost(DataSet: TDataSet);
begin
  Sistema.MarcaTabelaParaImportar('CADUNIDADE');
end;
...
begin
  ...
  CadUnidadeD_ULT_ALT.AsDateTime := Sistema.RDataServidor;
end;

procedure TFUnidades.CadUnidades1AfterPost(DataSet: TDataSet);
begin
  Sistema.MarcaTabelaParaImportar('CADUNIDADE');
end;

procedure TFUnidades.CadUnidades1BeforePost(DataSet: TDataSet);
begin
  CadUnidades1.FieldByName('D_ULT_ALT').AsDateTime := Sistema.RDataServidor;
end;

procedure TFUnidades.CadUnidades2AfterPost(DataSet: TDataSet);
begin
  Sistema.MarcaTabelaParaImportar('CADUNIDADE');
end;

procedure TFUnidades.CadUnidades2BeforePost(DataSet: TDataSet);
begin
  CadUnidades2.FieldByName('D_ULT_ALT').AsDateTime := Sistema.RDataServidor;
end;
...
begin
  //atualiza a data de alteracao para poder exportar
  MovIndiceConversaoD_ULT_ALT.AsDateTime := Sistema.RDataServidor;
end;
